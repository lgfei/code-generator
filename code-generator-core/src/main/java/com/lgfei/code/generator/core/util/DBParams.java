...
public class DBParams
{
    ...
    private static final int[] SQLTYPES =
        {Types.INTEGER, Types.BIGINT, Types.VARCHAR, Types.DATE, Types.TIMESTAMP, Types.DOUBLE, Types.TIME};
    
    /**  
     * Java数据基本类型，SQLTYPES与CLASSTYPES类型是一一对应的  
     */
    private static final Class<?>[] CLASSTYPES =
        {Integer.class, Long.class, String.class, Date.class, Timestamp.class, Double.class, Time.class};
     ...
     */
    public void prepareStatement(PreparedStatement pst, int startIndex)
        throws SQLException
    {
     ...
     * @throws SQLException  
     */
    public void prepareStatement(PreparedStatement pst)
        throws SQLException
    {
